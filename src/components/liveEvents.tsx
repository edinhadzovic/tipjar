        ...
        <div className="space-y-4 mx-6">
            ...
            {!events.length ?
                <div className="max-h-[300px] overflow-auto space-y-4">
                    {events.map((event) => (
                        <div
                            className={`flex flex-col space-y-3 sm:space-x-3 sm:flex-row text-dark-jungle px-5 py-2 items-start sm:items-center rounded-lg`} 
                            key={event.hash}
                        >
            ...
            : 
                <div className="text-center flex justify-center items-center h-[200px] text-dark-jungle-light">
